...
use App\Controller\Admin\Factory\PaginatorFactory;
...
abstract class AbstractCrudController extends AbstractController implements CrudControllerInterface
{
    ...
    public function index(AdminContext $context)
    {
        ...
        $actions = $this->container
            ->get(EntityFactory::class)
            ->processActionsForAll($entities, $context->getCrud()->getActionsConfig());
    ...
    public function detail(AdminContext $context)
    {
        ...
        if (
            !$this->isGranted(Permission::EA_EXECUTE_ACTION, [
    ...
    public function edit(AdminContext $context)
    {
        ...
        $this->container
            ->get(EntityFactory::class)
            ->processFields($context->getEntity(), FieldCollection::new($this->configureFields(Crud::PAGE_EDIT)));
        $context->getCrud()->setFieldAssets($this->getFieldAssets($context->getEntity()->getFields()));
        $this->container
            ->get(EntityFactory::class)
            ->processActions($context->getEntity(), $context->getCrud()->getActionsConfig());
        ...
        if ($context->getRequest()->isXmlHttpRequest()) {
            ...
            if (
                !$this->isCsrfTokenValid(BooleanField::CSRF_TOKEN_NAME, $context->getRequest()->query->get('csrfToken'))
            ) {
    ...
    public function delete(AdminContext $context)
    {
        ...
        try {
            ...
            throw new EntityRemoveException([
                'entity_name' => $context->getEntity()->getName(),
    ...
    public function batchDelete(AdminContext $context, BatchActionDto $batchActionDto): Response
    {
        ...
        foreach ($batchActionDto->getEntityIds() as $entityId) {
            ...
            if (
                !$this->isGranted(Permission::EA_EXECUTE_ACTION, ['action' => Action::DELETE, 'entity' => $entityDto])
            ) {
                throw new ForbiddenActionException($context);
            }
            ...
            try {
                ...
                throw new EntityRemoveException([
                    'entity_name' => $entityDto->toString(),
                    'message' => $e->getMessage(),
                ]);
            }
    ...
    protected function getFieldAssets(FieldCollection $fieldDtos): AssetsDto
    {
        ...
        $currentPageName = $this->getContext()
            ?->getCrud()
            ?->getCurrentPage();
